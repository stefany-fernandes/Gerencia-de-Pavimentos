    ...
    <center>
        ...
        <div class="container">
            <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
                ...
                <form id = "login" class="col s12" method="post" action="login">
                    <div class='row'>
                        <div class='col s12'>
                        </div>
                    </div>
                    ...
                    <center>
                        <div class='row'>
                            <a class="btn-floating btn-large waves-effect waves-light red" onclick="document.getElementById('login').submit()"><i class="material-icons">done</i></a>
                        </div>
                    </center>
                </form>
            </div>
